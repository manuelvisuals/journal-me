...
//      spariscono;
//   6. la linguetta Feedback resta MUTA finche il pannello non le da un
//      indirizzo: il messaggio dice "scrivimi" e l'animazione di chiusura
//      vola dentro di lei, quindi e li che uno ci prova.
   ...
   ============================================================ */
{
  ...
  check("senza indirizzo la linguetta e un bottone, non un link", tag === "button", tag);
  await page.close();
