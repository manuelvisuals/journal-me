...
// /api/ospite/braccialetto (10 settembre 2026, decisione 2A): il braccialetto
// nasce sul server, con il token DeviceCheck nel guscio; porta il segreto
// e il token, niente testo del diario.
export const ROUTE_AMMESSE_OSPITE = [...ROUTE_AI_OSPITE, "/api/ospite/stato", "/api/ospite/braccialetto", "/api/apple/verifica"];
