 ...
 *
 * Il braccialetto puo portare anche un PREMIUM (migration 025: comprato
 * senza email con il foglio di Apple). Dal 10 al 15 settembre 2026 questa
 * porta era chiusa ("premium vuole un account"); Apple l'ha bocciata
 * (5.1.1(v), 14 settembre) e Manuel l'ha riaperta: un braccialetto con un
 * premium valido passa di qui senza contare giornate del regalo.
 * adotta_braccialetto porta quel premium sull'account appena la persona
 * mette l'email, se e quando vuole.
 *
