...
/**
 * IL PREMIUM SUL DISPOSITIVO (mockup premium-senza-password, B1; tornato
 * il 15 settembre 2026 dopo la bocciatura Apple 5.1.1(v) del 14: un
 * acquisto in-app non puo pretendere una registrazione). Il server lo dice
 * in /api/ospite/stato e in /api/apple/verifica; qui si ricorda la
 ...
 *
 * TRAPPOLA (10-15 settembre): qui c'era `dimenticaPremiumVecchio()`, che a
 * ogni avvio CANCELLAVA questa chiave. Con il premium sul dispositivo
 * riacceso, ogni riavvio l'avrebbe spento e il bug sarebbe sembrato venire
 * da un'altra parte. Non rimetterla.
 */
