...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = [
    ...
    "    Le opzioni sono i tipi: cibo, attivita, persona, lavoro, luogo.",
    "    In ogni opzione, nome_vero e come va mostrata la cosa se si sceglie",
    "    quel tipo ('casa di Charlie', 'Charlie'). libero=false.",
