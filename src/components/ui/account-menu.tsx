...
function IconaEntra() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      {/* La freccia ENTRA nella porta (Manuel, 10 settembre 2026): prima
          puntava fuori, cioe era il segno dell'uscita sopra la voce "Ho gia
          un account". La porta sta a destra, la freccia ci va dentro. */}
