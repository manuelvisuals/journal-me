...
export const ABBONAMENTO: Record<string, string> = {
  ...
  "Grazie di averle usate. Puoi continuare a scrivere ogni giorno: manca solo la parte fatta dall'AI.": "Thanks for using them. You can keep writing every day: only the AI part is missing.",
  "Una prova gratis per provare tutto. Poi, se ti piace, resta.": "A free trial to try everything. Then, if you like it, stay.",
  "Premium si attiva dall'app per iPhone: {n} giorni gratis, poi {prezzo}. Con lo stesso account vale anche qui.": "Premium is activated from the iPhone app: {n} days free, then {prezzo}. With the same account it works here too.",
  "Annuale": "Yearly",
  "Mensile": "Monthly",
  ...
  "Dopo la prova si rinnova da solo a {prezzo} {periodo}, finche non lo disdici dalle Impostazioni di Apple.": "After the trial it renews automatically at {prezzo} {periodo}, until you cancel it from your Apple settings.",
  "Si rinnova da solo a {prezzo} {periodo}, finche non lo disdici dalle Impostazioni di Apple.": "It renews automatically at {prezzo} {periodo}, until you cancel it from your Apple settings.",
