...
export const ACCESSO: Record<string, string> = {
  ...
  "Inizia con premium": "Start with premium",
  "Inizia senza account": "Start without an account",
  "Continua gratis": "Continue for free",
  "il diario resta su questo telefono": "your diary stays on this phone",
  "niente voce e niente AI": "no voice and no AI",
  ...
  "Senza account il diario resta su questo telefono.": "Without an account your diary stays on this phone.",
  "Con premium le tue giornate salgono nel cloud gia criptate e la chiave resta sul tuo telefono. Quando usi l'AI il testo di quella giornata passa dai modelli AI e non viene salvato. Puoi cancellare tutto quando vuoi.": "With premium your days go to the cloud already encrypted and the key stays on your phone. When you use the AI, the text of that day goes through AI models and is not stored. You can delete everything whenever you want.",
