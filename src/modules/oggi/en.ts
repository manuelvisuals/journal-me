...
export const OGGI: Record<string, string> = {
  ...
  "Fatto": "Done",
  "chili": "kilos",
  "decimi di chilo": "tenths of a kilo",
  "Meno": "Minus",
  "Piu": "Plus",
  "sonno": "sleep",
  ...
  "Lascialo cosi": "Keep it as it is",
  "resta \"{nome}\" e non me lo chiedi piu": "stays \"{nome}\" and you will not ask again",
  "scarta": "discard",
  "Scartare la bozza?": "Discard the draft?",
  "Il testo scritto finora va perso.": "The text written so far will be lost.",
  "Scarta": "Discard",
  "Tienila": "Keep it",
  "non sono riuscito a salvare la sintesi": "could not save the summary",
  "sintesi della giornata": "summary of the day",
  "modifica la sintesi della giornata": "edit the summary of the day",
  ...
  "Era l'ultima giornata con l'AI in regalo.": "That was the last gift AI day.",
  "Ancora 1 giornata con l'AI in regalo.": "1 more gift AI day.",
  "Ancora {n} giornate con l'AI in regalo.": "{n} more gift AI days.",
  "Prova premium": "Try premium",
  "Chiudi l'avviso": "Close the notice",
  "Le {n} giornate con l'AI sono finite. Il diario continua.": "The {n} AI days are over. The diary goes on.",
};
