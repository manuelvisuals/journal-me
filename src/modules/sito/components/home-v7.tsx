/**
 * LA HOME DELL'11 SETTEMBRE 2026, CONGELATA. Copia esatta di home.tsx nel
 * momento in cui Manuel ha detto "il sito desktop ora e perfetto": eroe che
 * si apre allo scorrimento, "Come funziona" come scena bloccata, la
 * cassaforte, la giornata col titolo fermo e il marchio dentro la frase.
 * Da qui in avanti si lavora solo sulla versione telefono, e questa pagina
 * e il metro di paragone del desktop.
 *
 * COME RESTA FERMA. La radice porta `jm-sito4-archivio-v7` OLTRE a
 * `jm-sito7`: le due classi insieme vogliono dire "tutto il sito di oggi,
 * animazioni comprese, ma non toccarlo piu". Le regole nuove che si
 * scrivono da adesso in poi — che per accordo sono tutte dentro
 * `@media (max-width: 900px)` — devono escluderla:
 *
 *     .jm-sito7:not(.jm-sito4-archivio-v7) ...
 *
 * Se qualcuno se ne dimentica, il primo posto dove se ne accorge e /v7 sul
 * telefono, che comincia a somigliare alla home viva invece che a se
 * stessa. I testi (testi.ts) e le fotografie sono condivisi: le parole
 * nuove vanno in chiavi nuove, come si e sempre fatto qui.
 *
 * NON SI MODIFICA PIU. Le correzioni vanno in home.tsx.
 */
...
export function HomeSitoV7({
  ...
  return (
    <div className="jm-sito jm-sito4 jm-sito7 jm-sito4-archivio-v7">
      ...
      <PiedeSito lingua={lingua} altraLingua={altraLingua} versione="v7" />
