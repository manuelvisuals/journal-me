// CONGELATA: la home com era il 5 settembre 2026 sera, salvata su /v2 su
// richiesta di Manuel prima di rimetterci le mani. Non indicizzabile, non
// nella mappa del sito. Non si modifica: e una fotografia, non un ramo.
...
export function HomeSitoV2({
  ...
  return (
    <div className="jm-sito">
      ...
      <PiedeSito lingua={lingua} altraLingua={altraLingua} versione="v2" />
