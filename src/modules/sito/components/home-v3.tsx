// CONGELATA: la home com era il 7 settembre 2026, salvata su /v3 prima di
// darla in mano a un altra sessione. Non indicizzabile, non nella mappa.
// Non si modifica: e una fotografia, non un ramo.
...
export function HomeSitoV3({
  ...
  return (
    <div className="jm-sito">
      ...
      <PiedeSito lingua={lingua} altraLingua={altraLingua} versione="v3" />
