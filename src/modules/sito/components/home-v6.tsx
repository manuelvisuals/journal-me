// CONGELATA l'8 settembre 2026, prima delle animazioni di scorrimento
// (richiesta di Manuel: "backup del sito attuale nel piede con una V").
// Copia esatta di home.tsx di quel giorno; vive su /v6 e /en/v6 e si
// cancella quando la home animata e approvata. Non toccare.
...
export function HomeSitoV6({
  ...
  return (
    <div className="jm-sito jm-sito4">
      ...
      <PiedeSito lingua={lingua} altraLingua={altraLingua} versione="v6" />
