...
-- PRIMA del merge del branch ospite-server. E la migration 023 tale e quale.
-- Si puo rieseguire senza danni (if not exists / drop policy if exists / or replace):
-- provata due volte di fila su un Postgres 16 locale la notte del 3 settembre 2026.
